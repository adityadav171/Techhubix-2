      ...
      <section className="themes-content">
        <div className="container">
          ...
          <div className="results-info">
            <p>
              Showing <span className="count">{filteredThemes.length}</span>{" "}
              theme{filteredThemes.length !== 1 ? "s" : ""}
                ...
                <div className="theme-card">
                  ...
                  <div className="theme-info">
                    ...
                    <div className="theme-footer">
                      ...
                      <span className="theme-layouts">
                        {theme.specifications.layouts} Layouts
                      </span>
                    </div>
                  </div>
                </div>
        ...
        <div className="benefits-content">
          ...
          <div className="benefits-grid">
            <div className="benefit-item">
              ...
              <p>
                Each theme is crafted by professional designers with modern
                aesthetics and user experience in mind.
              </p>
            </div>
            <div className="benefit-item">
              <div className="benefit-icon">📱</div>
              ...
              <p>
                All themes are mobile-friendly and work perfectly on all
                devices, from phones to large desktop screens.
              </p>
            </div>
            <div className="benefit-item">
              ...
              <p>
                Customize colors, fonts, and layouts with an intuitive
            ...
            <div className="benefit-item">
              ...
              <p>
                Optimized for speed and SEO. Your website will load fast and
            ...
            <div className="benefit-item">
              ...
              <p>
                Built with security best practices and regular updates to keep
                your site protected.
              </p>
            </div>
            <div className="benefit-item">
              ...
              <h3>24/7 Support</h3>
              <p>
                Get dedicated support from our team whenever you need help with
                your theme.
              </p>
            </div>
          </div>
